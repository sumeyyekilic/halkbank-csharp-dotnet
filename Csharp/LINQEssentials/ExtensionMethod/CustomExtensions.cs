...
namespace ExtensionMethod
{
    ...
    {
        //extension mettoların barındığı class static olmak zorunda
        public static double GetSquare(this int value)//int tipini extent edeceksin dedim
        {
        ...
        {
            return isLowerCase ? (char)random.Next(97,
                123) : (char)random.Next(65, 91);
        }
