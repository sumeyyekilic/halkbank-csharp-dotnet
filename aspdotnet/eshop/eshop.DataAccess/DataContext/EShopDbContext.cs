...
namespace eshop.DataAccess.DataContext
{
    public class EShopDbContext : DbContext
    {
        ...
        //bankacılıkta genelde  önce db tasarlamak. tasarlanmış db ye uyarlamayı tercşh ediyoruz.
        //zaman zaman uyg iht yönelik , kodu yazarız. sistem yazdığımız koda göre vt tasralar
